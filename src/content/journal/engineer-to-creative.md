...
Here's why. Engineering teaches you to see systems before you see parts. You learn to think in inputs and outputs, dependencies, feedback loops, the way a change in one place shows up somewhere you didn't expect. You stop looking at things as isolated objects and start looking at how they connect. That habit doesn't switch off when the work becomes visual.

## The move to the front end
